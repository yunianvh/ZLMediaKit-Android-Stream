...
package com.rust.sip.GB28181.sip.message;


import android.text.TextUtils;

import com.rust.sip.GB28181.net.UdpPacket;
import com.rust.sip.GB28181.sip.address.NameAddress;
import com.rust.sip.GB28181.sip.address.SipURL;
import com.rust.sip.GB28181.sip.header.AcceptContactHeader;
import com.rust.sip.GB28181.sip.header.AcceptHeader;
import com.rust.sip.GB28181.sip.header.AlertInfoHeader;
import com.rust.sip.GB28181.sip.header.AllowHeader;
import com.rust.sip.GB28181.sip.header.AuthenticationInfoHeader;
import com.rust.sip.GB28181.sip.header.AuthorizationHeader;
import com.rust.sip.GB28181.sip.header.CSeqHeader;
import com.rust.sip.GB28181.sip.header.CallIdHeader;
import com.rust.sip.GB28181.sip.header.ContactHeader;
import com.rust.sip.GB28181.sip.header.ContentLengthHeader;
import com.rust.sip.GB28181.sip.header.ContentTypeHeader;
import com.rust.sip.GB28181.sip.header.DateHeader;
import com.rust.sip.GB28181.sip.header.ExpiresHeader;
import com.rust.sip.GB28181.sip.header.FromHeader;
import com.rust.sip.GB28181.sip.header.Header;
import com.rust.sip.GB28181.sip.header.MaxForwardsHeader;
import com.rust.sip.GB28181.sip.header.MultipleHeader;
import com.rust.sip.GB28181.sip.header.ProxyAuthenticateHeader;
import com.rust.sip.GB28181.sip.header.ProxyAuthorizationHeader;
import com.rust.sip.GB28181.sip.header.RecordRouteHeader;
import com.rust.sip.GB28181.sip.header.RequestLine;
import com.rust.sip.GB28181.sip.header.RouteHeader;
import com.rust.sip.GB28181.sip.header.ServerHeader;
import com.rust.sip.GB28181.sip.header.SipHeaders;
import com.rust.sip.GB28181.sip.header.StatusLine;
import com.rust.sip.GB28181.sip.header.SubjectHeader;
import com.rust.sip.GB28181.sip.header.ToHeader;
import com.rust.sip.GB28181.sip.header.UserAgentHeader;
import com.rust.sip.GB28181.sip.header.ViaHeader;
import com.rust.sip.GB28181.sip.header.WwwAuthenticateHeader;
import com.rust.sip.GB28181.sip.provider.ConnectionIdentifier;
import com.rust.sip.GB28181.sip.provider.DialogIdentifier;
import com.rust.sip.GB28181.sip.provider.MethodIdentifier;
import com.rust.sip.GB28181.sip.provider.SipParser;
